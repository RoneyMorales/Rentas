...
namespace BL.Rentas
{
    public class ProductosBL
    {
        ...
        {
            var productos = _contexto.Productos.Where(producto => producto.Activo == activo).ToList();
            ListaProductos = new BindingList<Producto>(productos);
        ...
        {
            var productos = _contexto.Productos.Where(producto => producto.Descripcion.Contains(descripcion) == true).ToList();
            ListaProductos = new BindingList<Producto>(productos);
